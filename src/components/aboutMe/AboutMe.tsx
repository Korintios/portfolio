export default function AboutMe() {
    return (
        <section className="flex xsm:flex-col xsm:justify-center xl:justify-between xsm:gap-10 xl:gap-0 xl:flex-row items-center h-screen">
            <div className="flex flex-col gap-5">
                <h1 className="xsm:text-5xl xl:text-6xl font-bold">Un poco <b className="text-gradient-blue">Sobre Mi</b></h1>
                <p className="xsm:w-full xl:w-[500px] text-xl font-light leading-relaxed whitespace-normal">Comencé mi camino en este mundo hace aproximadamente dos años, cuando recibí la recomendación de estudiar esta carrera. Al iniciar mis estudios, <b className="text-gradient-blue">comencé con HTML</b> por consejo de un familiar y, poco después, ingresé a la universidad. <b className="text-gradient-blue">Mi primer lenguaje de programación fue Python</b>, y en paralelo aprendí <b className="text-gradient-blue">PHP</b> para prepararme en el ámbito laboral.
