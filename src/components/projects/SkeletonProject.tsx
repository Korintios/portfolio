export default function SkeletonProject() {
    return (
        <div className="flex xsm:flex-col xl:flex-row justify-between bg-[#f2f4f7] xsm:h-[608px] xsm:w-[358px] xl:w-[758px] xl:h-[335px] xsm:pl-0 xl:pl-8 pl-8 rounded-lg">
            ...
            <div className="bg-[#e8e8e9] xsm:w-[358px] xsm:h-[316.5px] xl:h-[335px] xl:w-[316.5px] xsm:rounded-b-lg xl:rounded-e-lg animate-pulse"/>
        </div>
    );
}