...
export default function Project({
	...
	return (
		<div className="flex xsm:flex-col xl:flex-row bg-[#f2f4f7] xsm:h-[608px] xsm:w-[358px] md:w-[360px] xl:w-[608px] 2xl:w-[758px] xl:h-[335px] xsm:pl-0 xl:pl-8 rounded-lg portfolio-project">
