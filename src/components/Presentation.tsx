		...
		<section className="min-h-screen sm:h-screen p-10 xl:p-20 flex flex-col justify-between">
			<div className="flex flex-col gap-4">
				...
				<div className="flex flex-row gap-4 mt-2">
					...
					<a href="docs/cv.pdf" className="font-poppins text-center content-center font-semibold text-sm xl:text-[15px]  cursor-pointer min-w-[139px] min-h-[43.61px] rounded-xl border-2 border-[#828282] text-[#828282] hover:bg-[#0e0e0e]">{t('viewCV')}</a>
				</div>
			</div>
