...
const EN: Lang = {
		...
		experiences: [
			{
				...
				details:
					"Hello, I am Juan Camilo. I am a full-stack developer experienced in diverse technologies, as well as a UI/UX designer in progress, focused on creating intuitive and engaging user experiences.",
			},
			{
				count: "7",
				description: "Clients worldwide...",
				details:
					"Nearly two years of experience have allowed me to quickly acquire the skills needed to effectively meet my clients' needs.",
			},
		],
		quote:
			"A fundamental part of learning lies in the discipline of practicing every day",
		contactInfo: [
			{
				icon: PhoneIcon,
				text: "+57 3147685292",
		...
		events: [
			{
				...
				description:
					"During this stage, I acquired a solid foundation in programming, starting with Python, where I quickly developed fundamental competencies. Subsequently, I explored Java with a focus on object-oriented programming, delving into advanced concepts that cemented my knowledge in software development.",
				styles: {
			...
			},
			{
				...
				description:
					"My first work experience as a PHP developer allowed me to learn about leadership, organization, and large-scale project management. Although challenging at first, I mastered the necessary tools and practices, achieving an advanced level in building robust solutions.",
				styles: {
			...
			},
			{
				...
				description:
					"I returned to the team to work as a maintenance programmer on a previously developed project. During this period, I focused on ensuring the system's proper functioning and optimization, achieving satisfactory results and meeting the team's expectations.",
				styles: {
					content: { color: "#000", borderTop: "2px solid #e4483a" },
					icon: { backgroundColor: "#e4483a", color: "#fff" },
				},
			...
			},
			{
				...
				title: "Lumxis",
				subtitle: "Frontend Leader",
				description:
					"Currently, I am a frontend leader at Lumxis, developing mobile applications with React Native and the Expo framework. I focus on creating intuitive interfaces and optimizing user experience on iOS and Android platforms. I also manage cloud services to ensure performance and scalability while providing support and mentoring to new team members.",
				styles: {
			...
			},
			{
				...
				description:
					"Currently, I focus on advanced programming concepts and quality project development. I dedicate my efforts to presenting innovative solutions, demonstrating commitment and excellence in every delivery.",
				styles: {
					content: { color: "#000", borderTop: "2px solid #0085ff" },
					icon: { backgroundColor: "#0085ff", color: "#fff" },
				},
			...
			},
			{
				...
				description:
					"Currently, I am part of a dynamic team at an innovative startup focused on addressing and solving a wide range of challenges within the software ecosystem. My role involves the development, implementation, and optimization of various tools and technological solutions, which I handle with a high degree of expertise and precision. This experience has allowed me to not only solidify my technical skills but also make meaningful contributions to projects aimed at transforming and improving processes within the industry.",
				styles: {
	...
	whyHireMe: {
		...
		description:
			"I learn quickly, work precisely, and prioritize quality in every project I develop. My leadership, organization, and attention to detail ensure flawless and punctual deliveries.",
		statistics: [
		...
		portfolio: [
			{
				...
				description:
					"A hair salon application for managing appointments, clients, services, and products.",
			...
			},
			{
				title: "EasyferrumJS",
				description:
					"JavaScript library for retrieving data from the university application of Comfenalco University.",
			...
			},
			{
				title: "MiLogin",
				description:
					"Minecraft plugin focused on authentication security for servers.",
			...
			},
			{
				...
				description:
					"A bingo application to create your personalized cards and print them.",
		...
		reviews: [
			{
				...
				score: 5,
				review:
					"Working with Juan Camilo has been an invaluable experience. His focus on quality and his ability to deliver quick and effective solutions are unmatched. During his time with us at REDTIC, he demonstrated a deep commitment to module development and server implementation, always ensuring the highest technical and practical standards.",
			},
			{
				...
				score: 5,
				review:
					"At Seisk, his ability to manage databases and document processes accurately was key to the success of our projects. He always prioritized client comfort and company needs, quickly adapting to any challenge.",
			},
            {
                image: 'images/reviews/backendito.jpg',
                name: 'Backendito Corp.',
                title: 'Corporation of Development',
                score: 5,
                review: 'Excellent attitude, clear and effective communication, friendly and professional customer service, fast and, above all, high-quality work! I am completely satisfied with the service provided and would highly recommend it without hesitation. It was a pleasure working with such a competent and dedicated team!'
            }
		],
	},
	formEmail: {
